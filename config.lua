...
Ticker = {
    ...
    Error_handle = { -- Do not touch, its for more user friendly errors
        ...
        ['cccagg_or_exchange'] = 'Inalid currency / coin combination', -- For some reason api throws this error if either coin or currency is invalid
    },
